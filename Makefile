...
CC = g++
COMPILEFLAGS = -I /usr/local/include -D_LINUX -D_REENTRANT -Wall  -O3 -march=nocona -msse3 -fno-strict-aliasing
LINKFLAGS = -L /usr/local/lib -lGVars3 -lcvd -lGLU -lGL -llapack $(3DSLIB)
